...
if __name__ == '__main__':
    ...
    '''
    print("---------------------------------------------------------------------------------------------")
    print("Number Theory and Cryptography(CO313) Mini Project")
    print("Topic: Implementation of Modified RSA cryptosystem based on offline storage and prime number.")
